...
process.source = cms.Source("PoolSource",
        fileNames = cms.untracked.vstring('file:008FC219-132A-E711-893F-A0000420FE80.root') )
...
# Schedule definition
process.schedule = cms.Schedule(process.hgcl1tpg_step, process.hgcreco_step, process.ntuple_step)
